...
public class ClientCache {
    ...
    public ClientCache(int userProfileCapacity, int musicProfileCapacity) {
    ...
    public Response fetch(Query query) {
        ...
        System.err.println("Client-side cache hit for: " + query.getHashString() + ". Cache size=" + cache.size());
        return response;
    }
